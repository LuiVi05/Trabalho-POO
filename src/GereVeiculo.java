...
public class GereVeiculo implements Serializable {
    ...
    public boolean criarVeiculo(String aMarca, String aModelo, String aMatricula, int aAnoPrimeiraMatricula,
            float aDistanciaPercorrida, boolean aIsDisponivel) {
        return registarVeiculo(
                new Veiculo(aMarca, aModelo, aMatricula, aAnoPrimeiraMatricula, aDistanciaPercorrida, aIsDisponivel));
    }
